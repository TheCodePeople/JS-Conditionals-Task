...
************************************************************************************************/
//  TODO: ADD YOUR CODE BELOW
let weather = prompt("enter weather for the day (e.g. sunny, cloudy, rainy, snowy). ")
switch(weather){
  case "sunny":
    console.log("recommendation: Choose lightweight cotton, linen, rayon, chambray, or silk fabrics for breathability and comfort. ")
  break
    case "rainy":
